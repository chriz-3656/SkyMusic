...
class QueuePageView(View):
    ...
    @discord.ui.button(emoji=PREV, style=discord.ButtonStyle.secondary, custom_id="queue_prev", label="Previous")
    ...
    @discord.ui.button(emoji=SKIP, style=discord.ButtonStyle.secondary, custom_id="queue_next", label="Next")
